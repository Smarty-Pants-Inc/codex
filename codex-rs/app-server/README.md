...
Responses remain bound to the turn that issued the request. A late response from an interrupted turn cannot resolve a tool call in a later turn, even if the call ID is reused.
