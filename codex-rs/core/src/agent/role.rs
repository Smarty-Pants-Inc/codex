        ...
        static CONFIG: LazyLock<BTreeMap<String, AgentRoleConfig>> = LazyLock::new(|| {
            BTreeMap::from([
                ...
                (
                    ...
                    AgentRoleConfig {
                        description: Some(
                            "Use `explorer` when a focused codebase question can be answered efficiently by delegation.\nNormal verification is still required; inspect relevant results and confirm them against the code when they affect your work."
                                .to_string(),
                        ),
