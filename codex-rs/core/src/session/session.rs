...
pub(crate) struct Session {
    ...
    /// Interactive request IDs registered in this session for legacy response routing.
    pub(super) seen_interactive_response_ids: std::sync::Mutex<HashSet<InteractiveResponseId>>,
